...
namespace GUI {
  ...
  static const std::vector<std::string> filament_vendors = 
    {"3Dgenius",               "3DJake",                 "3DXTECH",                "3D BEST-Q",              "3D Hero",
     ...
     "CC3D",                   "CERPRiSE",               "colorFabb",              "Comgrow",                "Cookiecad",
     "Creality",               "Das Filament",           "DO3D",                   "DOW",                    "DREMC",
     "DSM",                    "Duramic",                "ELEGOO",                 "Eryone",                 "Essentium",
     "eSUN",                   "Extrudr",                "Fiberforce",             "Fiberlogy",              "FilaCube",
     "Filamentive",            "FilamentOne",            "Fillamentum",            "Fil X",                  "FLASHFORGE",
     "Formfutura",             "Francofil",              "FusRock",                "GEEETECH",               "Giantarm",
     ...
     "Recreus",                "Regen",                  "Sain SMART",             "SliceWorx",              "Snapmaker",
...
static const std::vector<std::string> printer_vendors = 
    {"Anker",              "Anycubic",           "Artillery",          "Bambulab",           "BBL Panda Revo",
     "BIQU",               "Blocks",             "Chuanying",          "Co Print",           "CoLiDo",
     "Comgrow",            "CONSTRUCT3D",        "Creality",           "Cubicon",            "DeltaMaker",
     "Dremel",             "Elegoo",             "Flashforge",         "FLSun",              "FlyingBear",
     "Folgertech",         "Geeetech",           "Ginger Additive",    "InfiMech",           "innovatiQ",
     "Kingroon",           "Lulzbot",            "MagicMaker",         "Mellow",             "Orca Arena Printer",
     "Peopoly",            "Phrozen",            "Positron 3D",        "Prusa",              "Qidi",
     "Raise3D",            "RatRig",             "RolohaunDesign",     "SecKit",             "Snapmaker",
     "Sovol",              "Thinker X400",       "Tiertime",           "Tronxy",             "TwoTrees",
     "UltiMaker",          "Vivedino",           "Volumic",            "Voron",              "Voxelab",
     "Vzbot",              "Wanhao",             "Wanhao France",      "WonderMaker",        "Z-Bolt"};
...
static const std::unordered_map<std::string, std::vector<std::string>> printer_model_map =
    {{"Anker",             {"Anker M5",                   "Anker M5 All-Metal Hot End", "Anker M5C"}},
     {"Anycubic",          {"Anycubic 4Max Pro",     "Anycubic 4Max Pro 2",   "Anycubic Chiron",       "Anycubic Kobra",        "Anycubic Kobra 2",
                            "Anycubic Kobra 2 Max",  "Anycubic Kobra 2 Neo",  "Anycubic Kobra 2 Plus", "Anycubic Kobra 2 Pro",  "Anycubic Kobra 3",
                            "Anycubic Kobra Max",    "Anycubic Kobra Plus",   "Anycubic Kobra S1",     "Anycubic Vyper",        "Anycubic i3 Mega S"}},
     {"Artillery",         {"Artillery Genius",             "Artillery Genius Pro",         "Artillery Hornet",             "Artillery M1 Pro",             "Artillery Sidewinder X1",
                            "Artillery Sidewinder X2",      "Artillery Sidewinder X3 Plus", "Artillery Sidewinder X3 Pro",  "Artillery Sidewinder X4 Plus", "Artillery Sidewinder X4 Pro"}},
     {"Bambulab",          {"Bambu Lab X1 Carbon", "Bambu Lab X1",        "Bambu Lab X1E",       "Bambu Lab P1P",       "Bambu Lab P1S",
                            "Bambu Lab A1 mini",   "Bambu Lab A1"}},
     {"BBL Panda Revo",    {"Bambu Lab X1 Carbon Panda Revo Brass",            "Bambu Lab X1 Carbon Panda Revo Brass HF",         "Bambu Lab X1 Carbon Panda Revo Diamondback",      "Bambu Lab X1 Carbon Panda Revo ObXidian",         "Bambu Lab X1 Carbon Panda Revo ObXidian HF",
                            "Bambu Lab X1 Carbon Panda Revo HTA",              "Bambu Lab X1 Carbon Panda Revo High Temperature", "Bambu Lab X1 Carbon Panda Revo HF-HTA"}},
     ...
     {"CoLiDo",            {"CoLiDo 160 V2",     "CoLiDo DIY 4.0",    "CoLiDo DIY 4.0 V2", "CoLiDo SR1",        "CoLiDo X16"}},
     {"Comgrow",           {"Comgrow T300", "Comgrow T500"}},
     {"CONSTRUCT3D",       {"Construct 1",    "Construct 1 XL"}},
     {"Creality",          {"Creality CR-10 Max",          "Creality CR-10 SE",           "Creality CR-10 V2",           "Creality CR-10 V3",           "Creality CR-6 Max",
                            "Creality CR-6 SE",            "Creality CR-M4",              "Creality Ender-3",            "Creality Ender-3 Pro",        "Creality Ender-3 S1",
                            "Creality Ender-3 S1 Plus",    "Creality Ender-3 S1 Pro",     "Creality Ender-3 V2",         "Creality Ender-3 V2 Neo",     "Creality Ender-3 V3",
                            "Creality Ender-3 V3 KE",      "Creality Ender-3 V3 Plus",    "Creality Ender-3 V3 SE",      "Creality Ender-5",            "Creality Ender-5 Max",
                            "Creality Ender-5 Plus",       "Creality Ender-5 Pro (2019)", "Creality Ender-5 S1",         "Creality Ender-5S",           "Creality Ender-6", 
                            "Creality Hi",                 "Creality K1",                 "Creality K1 Max",             "Creality K1 SE",              "Creality K1C",     
                            "Creality K2 Plus",            "Creality Sermoon V1"}},
     {"Cubicon",           {"Cubicon xCeler-I"}},
     {"DeltaMaker",        {"DeltaMaker 2",   "DeltaMaker 2T",  "DeltaMaker 2XT"}},
     {"Dremel",            {"Dremel 3D20", "Dremel 3D40", "Dremel 3D45"}},
     {"Elegoo",            {"Elegoo Centauri",         "Elegoo Centauri Carbon",  "Elegoo Neptune",          "Elegoo Neptune 2",        "Elegoo Neptune 2D",
                            "Elegoo Neptune 2S",       "Elegoo Neptune 3",        "Elegoo Neptune 3 Max",    "Elegoo Neptune 3 Plus",   "Elegoo Neptune 3 Pro",
                            "Elegoo Neptune 4",        "Elegoo Neptune 4 Max",    "Elegoo Neptune 4 Plus",   "Elegoo Neptune 4 Pro",    "Elegoo Neptune X",
                            "Elegoo OrangeStorm Giga"}},
     {"Flashforge",        {"Flashforge AD5X",                "Flashforge Adventurer 3 Series", "Flashforge Adventurer 4 Series", "Flashforge Adventurer 5M",       "Flashforge Adventurer 5M Pro",
                            "Flashforge Guider 2s",           "Flashforge Guider 3 Ultra",      "Flashforge Guider4",             "Flashforge Guider4 Pro"}},
     {"FLSun",             {"FLSun Q5",               "FLSun QQ-S Pro",         "FLSun S1",               "FLSun Super Racer (SR)", "FLSun T1",
                            "FLSun V400"}},
     {"FlyingBear",        {"FlyingBear Ghost 6", "FlyingBear Reborn3", "FlyingBear S1"}},
     {"Folgertech",        {"Folgertech FT-5", "Folgertech FT-6", "Folgertech i3"}},
     {"Geeetech",          {"Geeetech A10 M",     "Geeetech A10 Pro",   "Geeetech A10 T",     "Geeetech A20",       "Geeetech A20 M",
                            "Geeetech A20 T",     "Geeetech A30 M",     "Geeetech A30 Pro",   "Geeetech A30 T",     "Geeetech M1",
                            "Geeetech Mizar",     "Geeetech Mizar M",   "Geeetech Mizar Max", "Geeetech Mizar Pro", "Geeetech Mizar S",
                            "Geeetech Thunder"}},
     {"Ginger Additive",   {"Ginger G1"}},
     {"InfiMech",          {"InfiMech TX",                       "InfiMech TX Hardened Steel Nozzle"}},
     {"innovatiQ",         {"TiQ2", "TiQ8"}},
     {"Kingroon",          {"Kingroon KLP1",        "Kingroon KP3S 3.0",    "Kingroon KP3S PRO S1", "Kingroon KP3S PRO V2", "Kingroon KP3S V1"}},
     {"Lulzbot",           {"Lulzbot Taz 4 or 5",   "Lulzbot Taz 6",        "Lulzbot Taz Pro Dual", "Lulzbot Taz Pro S"}},
     {"MagicMaker",        {"MM BoneKing", "MM hj SK",    "MM hqs SF",   "MM hqs hj",   "MM slb"}},
     {"Mellow",            {"M1"}},
     {"Orca Arena Printer",{"Orca Arena X1 Carbon"}},
     {"Peopoly",           {"Peopoly Magneto X"}},
     {"Phrozen",           {"Phrozen Arco"}},
     {"Positron 3D",       {"The Positron"}},
     {"Prusa",             {"Prusa CORE One",    "Prusa CORE One HF", "Prusa MINI",        "Prusa MINI IS",     "Prusa MK3.5",
                            "Prusa MK3S",        "Prusa MK4",         "Prusa MK4S",        "Prusa MK4S HF",     "Prusa XL",
                            "Prusa XL 5T"}},
     {"Qidi",              {"Qidi Q1 Pro",    "Qidi Q2",        "Qidi X-CF Pro",  "Qidi X-Max",     "Qidi X-Max 3",
                            "Qidi X-Plus",    "Qidi X-Plus 3",  "Qidi X-Plus 4",  "Qidi X-Smart 3"}},
     {"Raise3D",           {"Raise3D Pro3",      "Raise3D Pro3 Plus"}},
     {"RatRig",            {"RatRig V-Cast",                        "RatRig V-Core 3 200",                  "RatRig V-Core 3 300",                  "RatRig V-Core 3 400",                  "RatRig V-Core 3 500",
                            "RatRig V-Core 4 300",                  "RatRig V-Core 4 400",                  "RatRig V-Core 4 500",                  "RatRig V-Core 4 HYBRID 300",           "RatRig V-Core 4 HYBRID 400",
                            "RatRig V-Core 4 HYBRID 500",           "RatRig V-Core 4 IDEX 300",             "RatRig V-Core 4 IDEX 300 COPY MODE",   "RatRig V-Core 4 IDEX 300 MIRROR MODE", "RatRig V-Core 4 IDEX 400",
                            "RatRig V-Core 4 IDEX 400 COPY MODE",   "RatRig V-Core 4 IDEX 400 MIRROR MODE", "RatRig V-Core 4 IDEX 500",             "RatRig V-Core 4 IDEX 500 COPY MODE",   "RatRig V-Core 4 IDEX 500 MIRROR MODE",
                            "RatRig V-Minion"}},
     {"RolohaunDesign",    {"Rook MK1 LDO"}},
     {"SecKit",            {"SecKit SK-Tank", "Seckit Go3"}},
     {"Snapmaker",         {"Snapmaker A250",               "Snapmaker A250 BKit",          "Snapmaker A250 Dual",          "Snapmaker A250 Dual BKit",     "Snapmaker A250 Dual QS+B Kit",
                            "Snapmaker A250 Dual QSKit",    "Snapmaker A250 QS+B Kit",      "Snapmaker A250 QSKit",         "Snapmaker A350",               "Snapmaker A350 BKit",
                            "Snapmaker A350 Dual",          "Snapmaker A350 Dual BKit",     "Snapmaker A350 Dual QS+B Kit", "Snapmaker A350 Dual QSKit",    "Snapmaker A350 QS+B Kit",
                            "Snapmaker A350 QSKit",         "Snapmaker Artisan",            "Snapmaker J1",                 "Snapmaker U1"}},
     {"Sovol",             {"Sovol SV01 Pro",      "Sovol SV02",          "Sovol SV05",          "Sovol SV06",          "Sovol SV06 ACE",
                            "Sovol SV06 Plus",     "Sovol SV06 Plus ACE", "Sovol SV07",          "Sovol SV07 Plus",     "Sovol SV08",
                            "Sovol Zero"}},
     {"Thinker X400",      {"Thinker X400"}},
     {"Tiertime",          {"Tiertime UP300 HS",  "Tiertime UP310 Pro", "Tiertime UP400 Pro", "Tiertime UP600 HS"}},
     {"Tronxy",            {"Tronxy X5SA 400 Marlin Firmware"}},
     {"TwoTrees",          {"TwoTrees SK1",          "TwoTrees SP-5 Klipper"}},
     {"UltiMaker",         {"UltiMaker 2"}},
     {"Vivedino",          {"Troodon 2.0 - Klipper", "Troodon 2.0 - RRF"}},
     {"Volumic",           {"EXO42",             "EXO42 IDRE",        "EXO42 Performance", "EXO42 Stage 2",     "EXO65",
                            "EXO65 IDRE",        "EXO65 Performance", "EXO65 Stage 2",     "SH65",              "SH65 IDRE",
                            "SH65 Performance",  "SH65 Stage 2",      "VS20MK2",           "VS30MK2",           "VS30MK3",
                            "VS30MK3 Stage 2",   "VS30SC",            "VS30SC2",           "VS30SC2 Stage 2",   "VS30ULTRA"}},
     {"Voron",             {"Voron 0.1",            "Voron 2.4 250",        "Voron 2.4 300",        "Voron 2.4 350",        "Voron Switchwire 250",
     ...
     {"Wanhao France",     {"D12 230 PRO M2 DIRECT",                   "D12 230 PRO M2 MONO DUAL",                "D12 230 PRO M2 MONO DUAL PoopTool",       "D12 230 PRO SMARTPAD DIRECT",             "D12 230 PRO SMARTPAD MONO DUAL",
                            "D12 230 PRO SMARTPAD MONO DUAL PoopTool", "D12 300 PRO M2 DIRECT",                   "D12 300 PRO M2 MONO DUAL",                "D12 300 PRO M2 MONO DUAL PoopTool",       "D12 300 PRO SMARTPAD DIRECT",
                            "D12 300 PRO SMARTPAD MONO DUAL",          "D12 300 PRO SMARTPAD MONO DUAL PoopTool", "D12 500 PRO M2 DIRECT",                   "D12 500 PRO M2 MONO DUAL",                "D12 500 PRO M2 MONO DUAL PoopTool",
                            "D12 500 PRO SMARTPAD DIRECT",             "D12 500 PRO SMARTPAD MONO DUAL",          "D12 500 PRO SMARTPAD MONO DUAL PoopTool"}},
     {"WonderMaker",       {"WonderMaker ZR",         "WonderMaker ZR Ultra",   "WonderMaker ZR Ultra S"}},
     {"Z-Bolt",            {"Z-Bolt S1000",      "Z-Bolt S1000 Dual", "Z-Bolt S300",       "Z-Bolt S300 Dual",  "Z-Bolt S400",
                            "Z-Bolt S400 Dual",  "Z-Bolt S600",       "Z-Bolt S600 Dual",  "Z-Bolt S800 Dual"}}};
